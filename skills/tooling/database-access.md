...
```
1. /kaynaklar/ klasöründe var mı?          → EVET: kullan
   ↓ HAYIR
2. Anna's Archive'da var mı?               → [[annas-archive]] protokolü
   ↓ HAYIR
3. Açık erişim kaynaklarda var mı?         → Aşağıdaki açık erişim kanalları
   ↓ HAYIR
...
4. PDF'i indir ve /kaynaklar/[Yazar_Yıl_Başlık.pdf] olarak kaydet
